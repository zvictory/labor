    ...
    <footer className="mt-20 border-t border-border bg-bone py-12">
      <div className="container grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link href={href('/about')} className="hover:text-brass">
                About
              </Link>
            </li>
            <li>
              <Link href={href('/delivery')} className="hover:text-brass">
                Delivery &amp; payment
              </Link>
            </li>
            <li>
              <Link href={href('/contacts')} className="hover:text-brass">
                Contacts
              </Link>
            </li>
            <li>
              <Link href={href('/terms')} className="hover:text-brass">
                Terms
              </Link>
            </li>
          </ul>
