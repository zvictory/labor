          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {!started ? (
              <button
                ...
                className="bg-ink text-bone hover:bg-brass dark:bg-bone dark:text-ink rounded-full px-7 py-3 text-xs font-bold tracking-[0.18em] uppercase transition cursor-pointer"
              >
                {copy.start}
              </button>
            ) : (
              <>
                <button
                  ...
                  className="border-border text-ink hover:border-brass hover:text-brass dark:text-bone inline-flex items-center gap-2 rounded-full border px-5 py-3 text-xs font-bold tracking-widest uppercase transition disabled:pointer-events-none disabled:opacity-35 cursor-pointer"
                >
                ...
                <button
                  type="button"
                  onClick={restart}
                  className="border-border text-ink hover:border-brass hover:text-brass dark:text-bone inline-flex items-center gap-2 rounded-full border px-5 py-3 text-xs font-bold tracking-widest uppercase transition cursor-pointer"
                >
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {currentStep.choices.map((choice) => (
                  <button
                    ...
                    className="group border-border bg-background hover:border-brass hover:bg-brass/5 min-h-36 border p-5 text-left transition hover:-translate-y-0.5 cursor-pointer"
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-5 flex flex-wrap gap-3">
                        ...
                        <button
                          ...
                          className="bg-ink text-bone hover:bg-brass dark:bg-bone dark:text-ink inline-flex h-11 items-center justify-center gap-2 rounded-full px-5 text-xs font-bold tracking-widest uppercase transition cursor-pointer disabled:opacity-50"
                        >
