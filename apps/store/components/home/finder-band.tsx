...
// Static marketing band — the "scent finder leads" idea. Links to the (future)
// /find-your-perfume route. Component-local per-locale copy. Ported verbatim
// from apps/web/src/components/home/finder-band.tsx.
