...
ActiveRecord::Schema[8.1].define(version: 2026_05_22_163011) do
  ...
  create_table "labor_accord_translations", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "labor_accord_id", null: false
    t.string "locale", null: false
    t.string "name"
    t.datetime "updated_at", null: false
    t.index ["labor_accord_id", "locale"], name: "idx_accord_trans_locale", unique: true
    t.index ["labor_accord_id"], name: "idx_accord_trans_accord"
  end

  create_table "labor_accords", force: :cascade do |t|
    t.string "color_hex"
    t.datetime "created_at", null: false
    t.string "name", null: false
    t.string "slug", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_labor_accords_on_slug", unique: true
  end

  create_table "labor_brand_translations", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "description"
    t.bigint "labor_brand_id", null: false
    t.string "locale", null: false
    t.text "story"
    t.datetime "updated_at", null: false
    t.index ["labor_brand_id", "locale"], name: "idx_brand_trans_locale", unique: true
    t.index ["labor_brand_id"], name: "idx_brand_trans_brand"
  end

  create_table "labor_brands", force: :cascade do |t|
  ...
  create_table "labor_campaign_products", force: :cascade do |t|
    t.bigint "labor_campaign_id", null: false
    t.integer "position", default: 0, null: false
    t.bigint "spree_product_id", null: false
    t.index ["labor_campaign_id", "spree_product_id"], name: "idx_camp_prod_unique", unique: true
    t.index ["labor_campaign_id"], name: "idx_camp_prod_camp"
    t.index ["spree_product_id"], name: "idx_camp_prod_prod"
  end

  create_table "labor_campaign_slide_translations", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "cta_label"
    t.bigint "labor_campaign_slide_id", null: false
    t.string "locale", null: false
    t.text "subtitle"
    t.string "title"
    t.datetime "updated_at", null: false
    t.index ["labor_campaign_slide_id", "locale"], name: "idx_camp_slide_trans_locale", unique: true
    t.index ["labor_campaign_slide_id"], name: "idx_camp_slide_trans_slide"
  end

  create_table "labor_campaign_slides", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "image_url"
    t.bigint "labor_campaign_id", null: false
    t.string "link_url"
    t.integer "position", default: 0, null: false
    t.datetime "updated_at", null: false
    t.index ["labor_campaign_id", "position"], name: "idx_camp_slide_position"
    t.index ["labor_campaign_id"], name: "idx_camp_slide_camp"
  end

  create_table "labor_campaign_translations", force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", null: false
    t.string "cta_label"
    t.bigint "labor_campaign_id", null: false
    ...
    t.string "title"
    t.datetime "updated_at", null: false
    t.index ["labor_campaign_id", "locale"], name: "idx_camp_trans_locale", unique: true
    t.index ["labor_campaign_id"], name: "idx_camp_trans_camp"
  end

  create_table "labor_campaigns", force: :cascade do |t|
    ...
    t.string "slug", null: false
    t.bigint "spree_promotion_id"
    t.datetime "starts_at"
    t.string "status", default: "draft", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_labor_campaigns_on_slug", unique: true
    t.index ["spree_promotion_id"], name: "idx_camp_promo"
    t.index ["status"], name: "index_labor_campaigns_on_status"
  end

  create_table "labor_fiscal_receipts", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["receipt_number"], name: "index_labor_fiscal_receipts_on_receipt_number", unique: true, where: "(receipt_number IS NOT NULL)"
    t.index ["spree_order_id"], name: "idx_fr_order"
  end

  create_table "labor_note_translations", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "description"
    t.bigint "labor_note_id", null: false
    t.string "locale", null: false
    t.string "name"
    t.datetime "updated_at", null: false
  ...
  create_table "labor_payment_webhook_events", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["provider", "external_txn_id", "event_type"], name: "idx_pwe_idempotency", unique: true
    t.index ["spree_order_id"], name: "idx_pwe_order"
    t.index ["spree_payment_id"], name: "idx_pwe_payment"
  end

  create_table "labor_perfumer_translations", force: :cascade do |t|
    t.text "bio"
    t.datetime "created_at", null: false
    t.bigint "labor_perfumer_id", null: false
    t.string "locale", null: false
    t.datetime "updated_at", null: false
    t.index ["labor_perfumer_id", "locale"], name: "idx_perf_trans_locale", unique: true
    t.index ["labor_perfumer_id"], name: "idx_perf_trans_perf"
  end

  create_table "labor_perfumers", force: :cascade do |t|
    t.string "country"
    t.datetime "created_at", null: false
    t.string "name", null: false
    t.string "slug", null: false
  ...
  create_table "labor_product_accords", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "labor_accord_id", null: false
    t.bigint "spree_product_id", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "labor_product_fragrance_details", force: :cascade do |t|
    t.decimal "avg_longevity", precision: 3, scale: 2, default: "0.0", null: false
    t.decimal "avg_rating", precision: 3, scale: 2, default: "0.0", null: false
    t.decimal "avg_sillage", precision: 3, scale: 2, default: "0.0", null: false
    t.string "concentration"
    t.datetime "created_at", null: false
    t.boolean "discontinued", default: false, null: false
    t.string "gender", default: "unisex", null: false
    t.bigint "labor_brand_id"
    t.jsonb "love_breakdown", default: {}, null: false
    t.integer "release_year"
    t.integer "reviews_count", default: 0, null: false
    t.jsonb "seasons_breakdown", default: {}, null: false
    t.bigint "spree_product_id", null: false
    t.jsonb "time_breakdown", default: {}, null: false
    t.datetime "updated_at", null: false
    t.integer "volume_ml"
  ...
  create_table "labor_product_notes", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "labor_note_id", null: false
    t.integer "position", default: 0, null: false
    t.string "pyramid_layer", null: false
    t.bigint "spree_product_id", null: false
    t.datetime "updated_at", null: false
    t.index ["labor_note_id"], name: "idx_pn_note"
    t.index ["spree_product_id", "labor_note_id", "pyramid_layer"], name: "idx_pn_unique", unique: true
    t.index ["spree_product_id"], name: "idx_pn_product"
  end

  create_table "labor_product_perfumers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "labor_perfumer_id", null: false
    t.bigint "spree_product_id", null: false
    t.datetime "updated_at", null: false
    t.index ["labor_perfumer_id"], name: "idx_pp_perfumer"
    t.index ["spree_product_id", "labor_perfumer_id"], name: "idx_pp_unique", unique: true
    t.index ["spree_product_id"], name: "idx_pp_product"
  end

  create_table "labor_product_similars", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.decimal "score", precision: 5, scale: 4, default: "0.0"
    t.bigint "similar_spree_product_id", null: false
    t.string "source", default: "computed"
    t.bigint "spree_product_id", null: false
    t.datetime "updated_at", null: false
    t.index ["similar_spree_product_id"], name: "idx_psim_similar"
    t.index ["spree_product_id", "similar_spree_product_id"], name: "idx_psim_unique", unique: true
    t.index ["spree_product_id"], name: "idx_psim_product"
  end

  create_table "labor_votes", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "longevity"
    t.string "love_level"
    t.integer "rating"
    ...
    t.jsonb "time_of_day", default: []
    t.datetime "updated_at", null: false
    t.index ["spree_product_id", "spree_user_id"], name: "idx_votes_unique", unique: true
    t.index ["spree_product_id"], name: "idx_votes_product"
    t.index ["spree_user_id"], name: "idx_votes_user"
  end

  create_table "labor_wishlist_items", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "spree_product_id", null: false
    t.bigint "spree_user_id", null: false
    t.index ["spree_product_id"], name: "idx_wl_product"
    t.index ["spree_user_id", "spree_product_id"], name: "idx_wl_unique", unique: true
    t.index ["spree_user_id"], name: "idx_wl_user"
  end
  ...
  create_table "spree_shipments", force: :cascade do |t|
    ...
    t.index ["delivery_external_id"], name: "index_spree_shipments_on_delivery_external_id"
    t.index ["delivery_provider"], name: "index_spree_shipments_on_delivery_provider"
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.string "phone"
    t.string "preferred_locale", default: "ru", null: false
    t.jsonb "private_metadata"
    t.jsonb "public_metadata"
    ...
    t.index ["telegram_id"], name: "index_spree_users_on_telegram_id", unique: true
    t.index ["telegram_username"], name: "index_spree_users_on_telegram_username"
  end
  ...
  add_foreign_key "labor_accord_translations", "labor_accords"
  add_foreign_key "labor_brand_translations", "labor_brands"
  add_foreign_key "labor_campaign_products", "labor_campaigns"
  add_foreign_key "labor_campaign_products", "spree_products"
  add_foreign_key "labor_campaign_slide_translations", "labor_campaign_slides"
  add_foreign_key "labor_campaign_slides", "labor_campaigns"
  add_foreign_key "labor_campaign_translations", "labor_campaigns"
  add_foreign_key "labor_campaigns", "spree_promotions"
  add_foreign_key "labor_fiscal_receipts", "spree_orders"
  add_foreign_key "labor_note_translations", "labor_notes"
  add_foreign_key "labor_payment_webhook_events", "spree_orders"
  add_foreign_key "labor_payment_webhook_events", "spree_payments"
  add_foreign_key "labor_perfumer_translations", "labor_perfumers"
  add_foreign_key "labor_product_accords", "labor_accords"
  add_foreign_key "labor_product_accords", "spree_products"
  add_foreign_key "labor_product_fragrance_details", "labor_brands"
  add_foreign_key "labor_product_fragrance_details", "spree_products"
  add_foreign_key "labor_product_notes", "labor_notes"
  add_foreign_key "labor_product_notes", "spree_products"
  add_foreign_key "labor_product_perfumers", "labor_perfumers"
  add_foreign_key "labor_product_perfumers", "spree_products"
  add_foreign_key "labor_product_similars", "spree_products"
  add_foreign_key "labor_product_similars", "spree_products", column: "similar_spree_product_id"
  add_foreign_key "labor_votes", "spree_products"
  add_foreign_key "labor_votes", "spree_users"
  add_foreign_key "labor_wishlist_items", "spree_products"
  add_foreign_key "labor_wishlist_items", "spree_users"
